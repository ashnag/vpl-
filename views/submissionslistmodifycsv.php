...
foreach($submissions_number as $sn){
	...
	echo "".$sn->userid.",'".$listAsso[$sn->userid]->{'firstname'}." ".$listAsso[$sn->userid]->{'lastname'};
	echo "',".$sn->submissions. ",". $c_submission->id;
	echo ",".$c_submission->vpl.",".count($y_data).",".$s.",".$c_submission->datesubmitted.",",1447817400-$c_submission->datesubmitted;
	echo "<br>";
