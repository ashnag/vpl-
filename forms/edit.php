...
echo "<span style='float:right'>*Keystrokes and other activities being logged on this screen to detect cheating.Please dont enter passwords or other sensitive data.</span><br>";
$vpl->print_footer();
